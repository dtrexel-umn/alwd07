...
(function(Drupal) {
  Drupal.behaviors.umn_search = {
    attach: function() {
        var cx = Drupal.settings.umn_search.cx;
...
;
(function (Drupal, $) {
    Drupal.behaviors.umn_mobile_menu = {
      attach: function() {
        var mobileSearch = false,
            searchButton = $('#umnhf-m-search');
        searchButton.on('click', function (event) {
          var searchForm = $('.gsc-control-searchbox-only').parent();
          event.preventDefault();
          if (!mobileSearch) {
            searchButton.addClass('mobile')
              .html('<span class="umnhf-m-cancel">&#x2715;</span> Cancel');
